  ...
  return (
    <div className="mx-auto min-h-screen max-w-2xl px-6 py-10">
      ...
      <p className="mb-8 text-sm text-secondary">
        This is a literal account of what LocalDesk does and doesn't send over the network, not a marketing summary.
      </p>
      ...
      <section className="mb-8">
        ...
        <p className="text-sm text-secondary">
          On first use, LocalDesk downloads the AI model itself (a public set of model weights, not anything about
      ...
      <section className="mb-8">
        ...
        <p className="text-sm text-secondary">
          LocalDesk has no login, no user accounts, and no analytics, cookies, fingerprinting, or third-party embeds
          of any kind.
        </p>
      </section>
